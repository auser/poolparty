...
Gem::Specification.new do |s|
  ...
  s.executables = ["cloud-configure", "cloud-vnc", "cloud-contract", "cloud-console", "cloud-ssh", "cloud-reboot", "cloud-bootstrap", "cloud-compile", "cloud-expand", "cloud-terminate", "cloud", "cloud-show", "cloud-start", "cloud-rsync", "cloud-list"]
  s.extra_rdoc_files = [
    "README.rdoc"
  ]
  s.files = [
