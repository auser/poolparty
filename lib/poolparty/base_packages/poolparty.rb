    ...
    plugin :poolparty do
      ...
      def enable                
        ...
        has_package(:name => "rubygems") do
          ...
          has_exec(:name => "build_messenger", :command => ". /etc/profile && server-build-messenger", :requires => get_gempackage("poolparty"), :ifnot => "/bin/ps | /bin/grep beam | /bin/grep node")
          has_exec(:name => "start_node", :command => ". /etc/profile && server-start-node", :requires => get_exec("build_messenger"), :ifnot => "/bin/ps | /bin/grep beam | /bin/grep node")
        ...
        execute_on_master do          
          ...
          has_exec(:name => "start master messenger", :command => ". /etc/profile && server-start-master", :requires => [get_gempackage("poolparty"), get_exec("build_messenger")], :ifnot => "/bin/ps | /bin/grep beam | /bin/grep master")
          
          has_exec(:name => "start client server", :command => ". /etc/profile && server-start-client", :requires => [get_gempackage("poolparty"), get_exec("build_messenger"), get_exec("start master messenger")], :ifnot => "/bin/ps | /bin/grep beam | /bin/grep client ")
